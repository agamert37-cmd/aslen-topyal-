        ...
        <div className="flex justify-between items-end mb-2">
          <div>
            <h2 className="text-xl font-bold text-foreground flex items-center gap-2">
              <Package className="w-5 h-5 text-cyan-400" /> Kafes Envanteri
            </h2>
          </div>
          <button
            onClick={() => setShowAddCage(true)}
            className="flex items-center gap-2 px-3 py-2 bg-cyan-600/20 hover:bg-cyan-600/30 text-cyan-400 text-sm font-bold rounded-xl transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          {icebergCages.length === 0 && (
            <div className="col-span-1 md:col-span-2 xl:col-span-3 text-center py-12 bg-white/5 rounded-3xl border border-border border-dashed">
              ...
              <p className="text-muted-foreground font-medium">Henüz sistemde hiç kafes tanımlanmamış.</p>
              <p className="text-sm text-muted-foreground mt-1">Iceberg işlemlerini kullanabilmek için hemen yeni bir kafes ekleyin.</p>
            </div>
          )}
        </div>
